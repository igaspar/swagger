...
exports.loginDinamicoPOST = function(args, res, next) {
  ...
  * primer login (Login-dinamico-in)
  **/
    var examples = {};
...
exports.loginExitosoConsultaEstablecimientoPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (Consulta-de-establecimiento-in)
  **/
    var examples = {};
  examples['application/json'] = {
...
exports.loginExitosoConsultaOrdenesInternacionalesPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (Consulta-de-ordenes-internacionales-in)
  **/
    var examples = {};
  examples['application/json'] = {
  "tipo de persona" : 1,
...
exports.loginExitosoConsultaOrdenesPagoPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (CuentasDeOrdenesDePago-in)
  **/
    var examples = {};
  examples['application/json'] = {
...
exports.loginExitosoCuentasATercerosPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (Consulta-de-cuentas-terceros-in)
  **/
    var examples = {};
  examples['application/json'] = {
...
exports.loginExitosoCuentasInterbancariasPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (Consulta-de-cuentas-interbancarias-in)
  **/
    var examples = {};
  examples['application/json'] = {
...
exports.loginExitosoCuentasPropiasPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * primer login (Consulta-de-cuentas-propias-in)
  **/
    var examples = {};
  examples['application/json'] = {
...
exports.validacinDeLoginDinmicoPOST = function(args, res, next) {
  /**
   * parameters expected in the args:
  * valor dinamico (Valida-login-dinamico-in)
  **/
    var examples = {};
  examples['application/json'] = [ {
  "firstName" : "wewew",
